...
## 6. Debug UI (для G1_0/G1_3/G1_4)
- Debug UI живёт в `Sandbox` сцене как простой Canvas/Panel префаб.
- Панель можно включать/выключать и использовать для выбора источника и камеры.
