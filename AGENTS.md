...
- Писать и отвечать на русском языке.
...
- PR должен быть на русском языке (заголовок и описание).
- When the user says the task is done (e.g., “задача выполнена”), switch to `main`, pull latest updates, move the task you worked on to `tasks/completed/`, commit this change if needed, and push it.
